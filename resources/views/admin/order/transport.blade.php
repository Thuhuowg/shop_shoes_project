                ...
                <div class="invoice p-3 m-auto" style="width:90%">
                    ...
                    <div class="row invoice-info">
                        ...
                        <div class="col-sm-4 invoice-col">
                            ...
                            <b>Đơn vị vận chuyển: </b>VN Express<br>
                            <b>Mã vận chuyển:</b> {{ 'ex'. str_replace('-','',strtotime(date($transaction->created_at))) . $transaction->id }}<br>
                            <b>Mã nhân viên gửi hàng:</b>NV010<br>
                            <b>Tên nhân viên gửi hàng:</b>Võ Ngọc Hương<br>
                            ...
                            <table class="table table-striped">
                                ...
                                @foreach ($transaction->orders as $orderProduct)
                                    <tr>
                                        ...
                                        <td>{{ number_format($orderProduct->product->price_sale * $orderProduct->quantity, 0, ',', '.') }}
                                            Đ
                                        </td>
                                    </tr>
                                    @php
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <p class="lead"><span data-lemma="amount" data-pos="NOUN" data-genre="WyJHRU5FUkFMIl0="
                                                  ...
                                                  class="elia_highlightedItem active activated"
                                                  data-hover="Click to learn"
