                    ...
                    <div class="col-lg-10 col-xl-7 m-lr-auto m-b-50">
                            ...
                            <div class="row">
                                <div class="col-3">
                                    <div class="form-group ">
                                        ...
                                        <div>
                                            <select name="province_id" id="type" class="form-control">
                                ...
                                <div class="col-3">
                                    <div class="form-group ">
                                        ...
                                        <div>
                                            <select name="district_id" id="type" class="form-control">
                                ...
                                <div class="col-3">
                                    <div class="form-group ">
                                        ...
                                        <div>
                                            <select name="ward_id" id="type" class="form-control">
                        ...
                        <div class="m-l-25 m-r--38 m-lr-0-xl">
                            <div class="col-11 mt-3">
                                ...
                                <div class="row form-group">
                                    <input type="radio" id="option2" name="options" value="option1">
                    ...
                    <div class="col-sm-12 col-lg-7 col-xl-5 m-lr-auto m-b-50 mt-20">
                        <div class="bor10 p-lr-40 p-t-30 p-b-40 m-lr-0-xl ">
                            ...
                            <div class="row">
                                ...
                                <div class="column-2">Fresh Strawberries</div>
                                <div class="col p-l-70 p-t-60">$ 36.00</div>
                            </div>
