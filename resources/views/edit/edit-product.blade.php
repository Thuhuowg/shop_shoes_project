...
@section('content')
    <div class="card card-default">
        ...
        <form method="post" action="{{route('update.product',['id'=>$pro->id])}}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <div>
                                <select name="category_id" class="form-control" >
                                    <option value="{{$pro->category_id}}">{{$cate->name}}</option>
                        ...
                        <div class="form-group">
                            ...
                            <div>
                                <select name="type_id" id="type" class="form-control" >
                                    <option value="{{$pro->type_id}}">{{$type_edit->name}}</option>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="name" placeholder="nhập tên sản phẩm" name="name" value="{{$pro->name}}">
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="slug" placeholder="slug" name="slug" value="{{$pro->slug}}">
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-sm-8">
                        ...
                        <div class="form-group">
                            <label for="description"> Mô tả </label>
                            <textarea id="summernote" name="description" class="form-control" placeholder="mô tả về sản phẩm">{{$pro->description}}</textarea>
                        </div>
                        <div class="form-group ">

                            <label>Tải nhiều ảnh </label>
                            <div class="input-group mb-3">
                                <input type="hidden" name="image_list" id="image_list" aria-label="Recipient's username" aria-describedby="button-addon2" value="{{$pro->image_list}}">
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <input type="number" name="price_default" class="form-control price_default" placeholder="Enter ..." value="{{$pro->price_default}}">
                        </div>
                        <div class="form-group">
                            <label for="voucher_sale">Discount (%) </label>
                            <input type="number" id="voucher_sale" name="voucher_sale" class="form-control" placeholder="Enter ..." value="{{$pro->voucher_sale}}">
                        </div>
                        <div class="form-group ">
                            <label>Tải ảnh đại diện sản phẩm </label>
                            <div class="input-group mb-3">
                                <input name="image" id="image" aria-label="Recipient's username" aria-describedby="button-addon2" value="{{$pro->image}}">
                                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal">
                                    <i class="fas fa-folder-open"></i>
                                </button>
                            </div>
                            <img src="/uploads/{{$pro->image}}" id="show_img" style="width: 100%;" >
                        </div>
                ...
                <div class="col-sm-2 float-right mb-3 mt-3 justify-content-center">
                    <div class="row d-flex" style="gap: 5px">
                        ...
                        <a href="{{route('admin')}}" class="col mt-0 btn btn-block btn-outline-secondary">Huỷ</a>
                    </div>
                </div>
            </div>
