    ...
    <div class="container">
            ...
            <div class="col-sm-6 col-lg-3 p-b-50">
                ...
                <form>
                    <div class="wrap-input1 w-full p-b-4">
                        <input class="input1 bg-none plh1 stext-107 cl7" type="text" name="email" placeholder="Nhập địa chỉ email">
        ...
        <div class="p-t-40">
            ...
            <p class="stext-107 cl6 txt-center">
                ...
                Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | Made with <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="#" target="_blank">Huogthu</a> &amp; distributed by <a href="#" target="_blank">Team 10</a>
                <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
